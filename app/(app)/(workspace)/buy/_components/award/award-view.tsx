...
export function AwardView({ data }: { data: AwardData | null }) {
    ...
    return (
      <Shell humanRef={data.humanRef} rfqId={data.rfqId} step={0}>
        <EmptyState
          ...
          action={
            <Button asChild variant="secondary" size="sm">
              <Link href={`/buy/rfqs/${data.rfqId}`}>Back to RFQ</Link>
            </Button>
          }
          className="py-12"
        />
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            <Button asChild variant="secondary">
              <Link href={`/buy/rfqs/${data.rfqId}/award?sel=${data.selectedQuotationId}`}>
                Back
              </Link>
            </Button>
  ...
  return (
    <Shell humanRef={data.humanRef} rfqId={data.rfqId} step={0}>
      <form method="get" action={`/buy/rfqs/${data.rfqId}/award`} className="flex flex-col gap-3">
