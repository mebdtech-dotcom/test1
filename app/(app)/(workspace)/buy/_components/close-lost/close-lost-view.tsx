...
export function CloseLostView({ data }: { data: CloseLostData | null }) {
        ...
        <div className="flex max-w-2xl flex-col gap-4">
          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            <Button asChild variant="secondary">
              <Link
                href={`/buy/rfqs/${data.rfqId}/close-lost?reason=${data.selectedReasonCode}&detail=${encodeURIComponent(
                  data.reasonText ?? "",
                )}`}
              >
                Back
  ...
  return (
    <Shell humanRef={data.humanRef} rfqId={data.rfqId}>
      <form
        method="get"
        action={`/buy/rfqs/${data.rfqId}/close-lost`}
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-end gap-2">
          <Button asChild variant="secondary">
            <Link href={`/buy/rfqs/${data.rfqId}`}>Cancel</Link>
          </Button>
